...
- A
  ...
  is a series of documents defining the best practices an organization follows to manage its cybersecurity risk.

  - Candidate should provide an example of a framework. The
    ...
    is a set of guidelines that private sector companies can follow to identify, detect, and respond to cyberattacks, including ways to prevent and recover from attacks. The five main functions of the CSF include:
